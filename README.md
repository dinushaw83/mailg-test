<div align="center">
  <img src="./public/assets/images/mailg-logo.svg" alt="MailG Logo" width="120" />
  <h1>MailG</h1>
</div>
...
The project is deployed at: **[Coming Soon]**
...
4. **Test thoroughly**:
   ...
   - Use the verification dashboard if applicable
...
- **Code style**: Follow existing patterns, use ESLint configuration
- **Commit messages**: Use conventional commits format (e.g., `feat:`, `fix:`, `docs:`)
- **Component structure**: Keep components focused and reusable
- **State management**: Use `usePersistedState` for user preferences
- **Documentation**: Update README if adding new features
- **Verification tasks**: Add tasks to `tasks.json` for new email workflows

### Areas for Contribution

- 🐛 **Bug fixes**: Check open issues for bugs
- ✨ **New features**: Email filters, advanced search, keyboard shortcuts
- 🎨 **UI improvements**: Themes, animations, responsive design
- ♿ **Accessibility**: ARIA labels, keyboard navigation, screen reader support
- 📝 **Documentation**: Improve README, add code comments, create guides
- 🧪 **Testing**: Add unit/integration/E2E tests
- 🌐 **Internationalization**: Add multi-language support
- 🚀 **Performance**: Optimize rendering, add virtualization, reduce bundle size
...
- [Lunr.js](https://lunrjs.com/) - Search engine
- [idb](https://github.com/jakearchibald/idb) - IndexedDB wrapper

Inspired by modern email clients and designed for AI model training and testing.

---

**Questions or issues?** Open an issue on GitHub or contact the maintainers.

**Want to use MailG for your AI training?** Check out the [Verifiers](#verifiers) section to get started!
