...
export default function SpamOrUnsubModal({ open, onClose, onReportSpam, onUnsubscribe }) {
  ...
  const card = {
    ...
    background: "#fff",
    borderRadius: 24,
    boxShadow: "0 10px 20px rgba(0,0,0,.2), 0 6px 6px rgba(0,0,0,.15)",
    ...
    <div style={overlay} onMouseDown={onOverlayClick}>
      ...
      >
        <div style={body}>
          ...
          <p style={p}>
            If you didn't sign up to receive this message, <strong>Report spam</strong> instead to help protect all
            MailG users from unwanted email.{" "}
        ...
        <div style={actions}>
          <button type="button" style={textBtn} onClick={onReportSpam}>
            Report spam
          </button>
          <button type="button" style={primaryBtn} onClick={onUnsubscribe}>
            Unsubscribe
          </button>
        </div>
      </div>
