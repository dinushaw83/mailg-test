...
export default function MoveToMenu({ anchorRef, labels = [], onSelect, onClose }) {
    ...
    return createPortal(
        <div ref={menuRef} role="menu" aria-label="Move to" style={style} onKeyDown={onKeyDown} tabIndex={-1}>
            ...
            >
                <div className="SK AX" style={{ border: "none", padding: 0, boxShadow: "none", userSelect: "none" }}>
                    <div className="asc" style={{ padding: "8px 8px 0", userSelect: "none" }}>
                        ...
                        <span
                            ...
                            aria-live="polite"
                            role="status"
                            style={{ overflow: "hidden", position: "absolute", top: "-1000px", width: 1, display: "inline-block", userSelect: "none" }}
                        >
                            ✔
                        </span>
                    </div>
                    ...
                    <div
                        ...
                        style={{ overflow: "hidden", position: "relative", border: "none", padding: 0, margin: "8px 8px 16px", userSelect: "none" }}
                    >
                    ...
                    <div className="J-M-Jz aiL" style={{ overflow: "auto", maxHeight: 240, userSelect: "none", minWidth: 12 }}>
                        {filtered.map((item, i) =>
                            item.id === "__sep__" ? (
                                <div key={`sep-${i}`} role="separator" style={{ borderTop: "1px solid #ebebeb", margin: "5px 0 6px" }} />
                            ) : (
                                <div
                                    key={item.id}
                                    className="J-N"
                                ...
                                >
                                    <div
                                        className="J-N-Jz"
                                        style={{ alignItems: "center", display: "flex", justifyContent: "space-between", position: "relative", userSelect: "none" }}
                                    >
                                        {item.name}
                                    </div>
                                </div>
                    ...
                    {/* Footer */}
                    <div className="J-Kh" role="separator" style={{ borderTop: "1px solid #ebebeb", marginTop: 5, marginBottom: 6, userSelect: "none" }} />
