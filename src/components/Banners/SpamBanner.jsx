...
import ConfirmDeleteSpamModal from "../MailActions/ConfirmDeleteSpamModal";

export default function SpamBanner() {
  const { deleteAllSpam } = useMailActions();
  ...
  return (
    <>
      ...
      <ConfirmDeleteSpamModal
        open={showConfirmModal}
        onClose={() => setShowConfirmModal(false)}
        onConfirm={handleConfirmDelete}
        selectedCount={0} // 0 means "all"
        isDeleteAll={true}
      />
    </>
  );
