  ...
  >
    <Box sx={{ display: "flex", alignItems: "flex-start" }}>
      ...
      <Box sx={{ ml: 2, textAlign: "left" }}>
        ...
        {subtitle && (
          <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mt: 0.5 }}>{subtitle}</Typography>
        )}
    ...
    <Box sx={{ display: "flex", alignItems: "center" }}>
      {status && (
        <Typography sx={{ color: "#1a73e8", fontSize: "0.875rem", fontWeight: 600, mr: 1 }}>{status}</Typography>
      )}
  ...
  <Card>
    <Box sx={{ p: 2.5 }}>
      ...
      <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 2 }}>
        Choose whether to save the things you do and places you go to get more relevant results, personalized maps,
          ...
          icon={
            <Box
              sx={{
                ...
                height: 18,
                borderRadius: "50%",
                background: webActivityStatus === "On" ? "#1a73e8" : "#9aa0a6",
              }}
            />
          }
        />
...
export default function PrivacyHub({ open, onClose, initialView = "dataAndPrivacy" }) {
  ...
  const handleSaveEdit = () => {
    if (editDialogOpen === "name") {
      ...
      setMailGAccountDataPrivacy({
        ...mailGAccountDataPrivacy,
        profileVisibility: {
          ...mailGAccountDataPrivacy.profileVisibility,
          profilePictureVisibility: editFormData.value,
        },
      });
  ...
  return (
    <Dialog fullScreen open={open} onClose={onClose} TransitionComponent={Transition}>
      <AppBar
        elevation={0}
        sx={{ position: "sticky", backgroundColor: "#fff", color: "#202124", borderBottom: "1px solid #e0e0e0" }}
      >
        <Toolbar>
          {isSubPage && (
          ...
          <Typography
            sx={{ ml: isSubPage ? 0.5 : 1, flex: 1, fontSize: "1.125rem", fontWeight: 500, letterSpacing: 0.2 }}
          >
            MailG Account
          </Typography>
          ...
          <Box sx={{ display: "flex" }}>
            ...
            <Box
              sx={{
                ...
                pr: { md: 2 },
                pl: 0,
                display: { xs: "none", md: isSubPage ? "none" : "block" },
                ml: 0,
              }}
            >
              <NavItem
                ...
                label="Personal info"
                active={activeView === "personalInfo"}
                onClick={() => handleNavigateToView("personalInfo")}
              />
              <NavItem
                icon={ShieldOutlinedIcon}
                label="Data & privacy"
                active={activeView === "dataAndPrivacy"}
                onClick={() => handleNavigateToView("dataAndPrivacy")}
              />
              <NavItem
              ...
              <NavItem
                ...
                onClick={() => handleNavigateToView("storage")}
              />
              <NavItem
                icon={ManageSearchOutlinedIcon}
                label="Preferences"
                active={activeView === "preferences"}
                onClick={() => handleNavigateToView("preferences")}
              />
            </Box>
                    ...
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 4 }}>
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                          Key privacy options to help you choose the data saved in your account, the ads you see, info
                          you share with others, and more
                        </Typography>
                      </Box>
                      ...
                      <Card>
                        <Box sx={{ p: 3, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                          <Box>
                            ...
                            <Button sx={{ textTransform: "none", color: "#1a73e8", px: 0 }}>
                              Review suggestion (1)
                            </Button>
                          </Box>
                      ...
                      <Box sx={{ mt: 4 }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                          <Button
                            sx={{ justifyContent: "flex-start", textTransform: "none", color: "#202124" }}
                            startIcon={<KeyboardArrowDownOutlinedIcon sx={{ color: "#1a73e8" }} />}
                          >
                      ...
                      <Box sx={{ mt: 3 }}>
                        ...
                        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.25 }}>
                          <Chip
                            icon={<ManageHistoryOutlinedIcon sx={{ color: "#1a73e8 !important" }} />}
                            label="My Activity"
                            variant="outlined"
                            sx={{
                              borderRadius: 99,
                          ...
                          />
                          <Chip
                            icon={<MapOutlinedIcon sx={{ color: "#1a73e8 !important" }} />}
                            label="NavMapper Timeline"
                            variant="outlined"
                            sx={{
                              borderRadius: 99,
                              borderColor: "rgba(100,121,143,0.28)",
                          ...
                          />
                          <Chip
                            icon={<PlayCircleOutlineIcon sx={{ color: "#d93025 !important" }} />}
                            label="StreamTube watch & search history"
                            variant="outlined"
                            sx={{
                              borderRadius: 99,
                              borderColor: "rgba(100,121,143,0.28)",
                            ...
                            <Card>
                              <Box sx={{ p: 2 }}>
                                ...
                                <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mt: 0.5 }}>
                                  You can choose whether the ads you see on MailG services and partner sites are
                                  personalized
                                </Typography>
                              </Box>
                              <Divider />
                              <Button
                                onClick={() => setActiveView("myAdCenter")}
                                sx={{ justifyContent: "space-between", textTransform: "none", py: 2, px: 2 }}
                              >
                                <Box sx={{ display: "flex", alignItems: "center" }}>
                                  <Box
                                    sx={{
                                ...
                                <Box sx={{ display: "flex", alignItems: "center" }}>
                                  ...
                                  <Typography sx={{ color: "#202124" }}>
                                    {privacySettings.adsPersonalizationEnabled ? "On" : "Off"}
                                  </Typography>
                              ...
                              <Box sx={{ p: 2, display: "flex", alignItems: "flex-start", gap: 1 }}>
                                ...
                                <Typography sx={{ fontSize: "0.75rem", color: "text.secondary" }}>
                                  We protect your privacy. Content from CloudVault, MailG, and other services is never
                                  used for any ads purposes.
                                </Typography>
                              </Box>
                            </Card>
                          </Grid>
                          <Grid item xs={12} md={6}>
                            <Card>
                              <Box sx={{ p: 2, flex: 1 }}>
                                ...
                                <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mt: 0.5 }}>
                                  Choose whether Search can show you personalized experiences based on data saved in
                                  your MailG account
                                </Typography>
                              </Box>
                              <Divider />
                              <Button
                                onClick={() => setActiveView("searchPersonalizationControls")}
                                sx={{ justifyContent: "space-between", textTransform: "none", py: 2, px: 2 }}
                              >
                                <Box sx={{ display: "flex", alignItems: "center" }}>
                                  <CheckCircleOutlineIcon sx={{ color: "#1a73e8", mr: 1 }} />
                      ...
                      <Box sx={{ mt: 6 }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", mb: 3 }}>
                          <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", maxWidth: 500 }}>
                            Personal info you've saved in your account, like your birthday or email address, and options
                            to manage it. This info is private to you, but you can make some of it visible to others on
                            MailG services.
                          </Typography>
                          <Box
                            sx={{
                        ...
                        <Paper sx={{ mb: 2, overflow: "hidden" }}>
                          <Button
                            ...
                            sx={{ justifyContent: "space-between", textTransform: "none", py: 2, px: 2, width: "100%" }}
                          >
                            <Box sx={{ display: "flex", alignItems: "center" }}>
                          ...
                          <Divider />
                          <Button
                            onClick={() => setActiveView("locationSharing")}
                            sx={{ justifyContent: "space-between", textTransform: "none", py: 2, px: 2, width: "100%" }}
                          >
                            <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                          <Chip
                            ...
                            variant="outlined"
                            sx={{ borderRadius: 999, borderColor: "rgba(100,121,143,0.28)" }}
                          />
                          <Chip
                            label="Subscriptions"
                            variant="outlined"
                      ...
                      <Box sx={{ mt: 6 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 3, maxWidth: 600 }}>
                          Your content and preferences related to the MailG services you use and third-party apps and
                          services
                        </Typography>
                        <Paper sx={{ overflow: "hidden" }}>
                          <Box sx={{ p: 2, borderBottom: "1px solid #e0e0e0" }}>
                            <Typography sx={{ fontSize: "0.95rem", fontWeight: 500, mb: 1 }}>
                              Content saved from MailG services
                            </Typography>
                            <Button
                              onClick={() => setActiveView("servicesDashboard")}
                              sx={{
                                justifyContent: "space-between",
                                textTransform: "none",
                                py: 1,
                            ...
                            >
                              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                                <Chip
                                  icon={<MailOutlineIcon sx={{ color: "#d93025 !important" }} />}
                                  label="MailG"
                                  variant="outlined"
                                  size="small"
                                  sx={{ borderRadius: 999 }}
                                />
                                <Chip
                                  icon={<StorageOutlinedIcon sx={{ color: "#1a73e8 !important" }} />}
                                  label="CloudVault"
                                  variant="outlined"
                                  size="small"
                                  sx={{ borderRadius: 999 }}
                          ...
                          <Button
                            onClick={() => setActiveView("thirdPartyApps")}
                            sx={{ justifyContent: "space-between", textTransform: "none", py: 2, px: 2, width: "100%" }}
                          >
                            <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        <Paper sx={{ overflow: "hidden" }}>
                          ...
                          >
                            <Box sx={{ display: "flex", alignItems: "center" }}>
                              ...
                              <Box>
                                <Typography sx={{ fontWeight: 500, color: "#b91c1c" }}>
                                  Delete your MailG Account
                                </Typography>
                                <Typography sx={{ fontSize: "0.875rem", color: "#dc2626" }}>
                                  Permanently delete your entire account and data.
                                </Typography>
                              </Box>
                            </Box>
                  ...
                  <CenterColumn>
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 3 }}>
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                          Choose which settings will save data in your MailG Account.
                        </Typography>
                      </Box>
                      ...
                      <OutlinedPanel>
                        ...
                        <Box sx={{ textAlign: "center", mb: 2 }}>
                          <Box component="svg" viewBox="0 0 100 50" sx={{ width: 240, height: "auto" }}>
                            ...
                            <text x="70" y="45" fontSize="6" fill="#9CA3AF" textAnchor="middle">
                              Web, Mobile, Tablet
                            </text>
                          </Box>
                        </Box>
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                          <CheckCircleOutlineIcon
                            sx={{ color: mailGAccountDataPrivacy.webActivityEnabled ? "#34a853" : "#9aa0a6" }}
                          />
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.75rem", ml: 5, mt: 1 }}>
                          {mailGAccountDataPrivacy.webActivityEnabled
                            ? "On since you created your account"
                            : "Turn on to save your activity"}
                        </Typography>
                        ...
                        <Button
                          sx={{ textTransform: "none", color: "#1a73e8", mt: 1, px: 0 }}
                      ...
                      <Box sx={{ textAlign: "center", mt: 3 }}>
                        <Button
                          onClick={() => setActiveView("dataAndPrivacy")}
                    ...
                    <Box>
                      ...
                      <OutlinedPanel>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.75rem", mt: 1 }}>
                          {mailGAccountDataPrivacy.locationHistoryEnabled
                            ? "On since you enabled it"
                            : "Off by default when you created your account"}
                        </Typography>
                  ...
                  <CenterColumn>
                    <Box>
                      ...
                      <OutlinedPanel>
                        ...
                        <Typography sx={{ color: "text.secondary", mb: 2 }}>
                          Save your StreamTube watch and search history to get better recommendations and remember where
                          you left off.
                          <Link href="#" underline="hover">
                            {" "}
                            Learn more
                  ...
                  <CenterColumn>
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 3 }}>
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                          Choose whether Search can show you personalized experiences based on saved data
                        </Typography>
                      </Box>
                      ...
                      <OutlinedPanel>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mt: 1 }}>
                          You get personalized versions of things like Discover stories, movie recommendations, and
                  ...
                  <CenterColumn>
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 3 }}>
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                          Simply turn off info you don't want used to personalize your ads.
                        </Typography>
                      </Box>
                      ...
                      >
                        ...
                        <FormGroup>
                          <FormControlLabel
                            control={
                              <Switch
                                checked={!!privacySettings.adsPersonalizationEnabled}
                                onChange={toggle("adsPersonalizationEnabled")}
                              />
                            }
                            label={privacySettings.adsPersonalizationEnabled ? "On" : "Off"}
                          />
                        </FormGroup>
                      </OutlinedPanel>
                      ...
                      <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1.5, mt: 3 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.75rem" }}>
                          We protect your privacy. Content from CloudVault, MailG, and other services is never used for
                          any ads purposes.
                        </Typography>
                      </Box>
                    </Box>
                    ...
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 3 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mt: 1 }}>
                          ...
                          <Link href="#" sx={{ color: "#1a73e8", textDecoration: "none" }}>
                            Learn more
                          </Link>
                        </Typography>
                      </Box>
                          ...
                          <React.Fragment key={app.id}>
                            ...
                            >
                              ...
                              <ChevronRightIcon
                                ...
                                onClick={() => setDeleteAppDialog(app.id)}
                              />
                            </Box>
                          </React.Fragment>
                        ))}
                  ...
                  <Box sx={{ display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: "100%", maxWidth: 680 }}>
                      <Box sx={{ textAlign: "left", mb: 3, px: 2 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem" }}>
                          Changes that you make here apply to Sign in with MailG, where you use it to sign in to
                      ...
                      <Box sx={{ px: 2 }}>
                        <Paper variant="outlined" sx={{ borderRadius: 2, p: 3 }}>
                          ...
                          >
                            <Box sx={{ flex: 1 }}>
                              ...
                              <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 1 }}>
                                Allow MailG to display a sign-in prompt on Android.{" "}
                                <Link href="#" sx={{ color: "#1a73e8", textDecoration: "none" }}>
                                  Learn more about sign-in prompts on Android
                                </Link>
                              </Typography>
                            </Box>
                            <Switch
                              ...
                              onChange={(e) =>
                                setSignInSettings({ ...signInSettings, signInPromptsEnabled: e.target.checked })
                              }
                              sx={{
                                ml: 2,
                          ...
                          <Typography sx={{ color: "text.secondary", fontSize: "0.875rem" }}>
                            To manage third-party sign-ins on Browser, go to Browser settings.{" "}
                            <Link href="#" sx={{ color: "#1a73e8", textDecoration: "none" }}>
                              Learn more about sign-in prompts on Browser
                            </Link>
                          </Typography>
                        </Paper>
                      </Box>
                ...
                <Box>
                  <Box sx={{ display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: "100%", maxWidth: 680 }}>
                      ...
                      <Grid container spacing={2} sx={{ mb: 4, px: 2 }}>
                        <Grid item xs={12} md={6}>
                          ...
                          >
                            ...
                            <Box sx={{ flex: 1 }}>
                              <Typography sx={{ fontWeight: 500, fontSize: "0.95rem", mb: 0.5 }}>
                                Download your data
                              </Typography>
                              <Typography sx={{ color: "text.secondary", fontSize: "0.875rem" }}>
                      ...
                      <Box sx={{ mb: 4, px: 2 }}>
                        <Typography sx={{ fontSize: "1.25rem", mb: 2, fontWeight: 500 }}>
                          Recently used MailG services (2)
                        </Typography>
                        <Grid container spacing={2}>
                          {/* MailG Service */}
                          <Grid item xs={12} md={6}>
                            <Paper variant="outlined" sx={{ borderRadius: 2, overflow: "hidden" }}>
                              <Box sx={{ p: 2, borderBottom: "1px solid #e0e0e0" }}>
                                ...
                                <Box sx={{ mb: 1 }}>
                                  ...
                                  <Typography sx={{ fontSize: "0.75rem", color: "text.secondary", ml: 3 }}>
                                    1 in inbox
                                  </Typography>
                                </Box>
                              ...
                              <Box sx={{ p: 1.5, display: "flex", gap: 1, flexWrap: "wrap" }}>
                                <Button
                                  size="small"
                                  variant="outlined"
                                  sx={{ textTransform: "none", fontSize: "0.75rem", borderRadius: 999 }}
                                >
                                  Download
                                </Button>
                                <Button
                  ...
                  <Box sx={{ display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: "100%", maxWidth: 680 }}>
                      <Box sx={{ textAlign: "left", mb: 3, px: 2 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 2 }}>
                          Location Sharing lets you share your real-time location from your devices with people you
                          choose.
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ px: 2, mb: 4 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 2 }}>
                          People you share your location with can see your name, photo, and real-time location across
                          MailG services, even when you're not using Maps. They can also see Location Sharing
                          notifications to know when you arrive at or leave specific locations.
                        </Typography>
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 3 }}>
                          Shared information may include where you've recently been, how you're traveling, and your
                          device info.
                        </Typography>
                        ...
                        <Paper
                          variant="outlined"
                          sx={{ p: 2, borderRadius: 2, display: "flex", alignItems: "center", gap: 2, mb: 3 }}
                        >
                          <Box
                            sx={{
                              width: 40,
                        ...
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mb: 1 }}>
                          <strong>Protect your privacy.</strong> To stop sharing your location with someone, tap Stop
                          next to their name. To temporarily stop all location sharing, turn off location in your device
                          settings.{" "}
                          <Link href="#" sx={{ color: "#1a73e8", textDecoration: "none" }}>
                            Learn more
                          </Link>
                      ...
                      <Box sx={{ px: 2, mb: 4 }}>
                        <Typography sx={{ color: "text.secondary", fontSize: "0.875rem" }}>
                          You can disable Location Sharing from{" "}
                          <Link href="#" sx={{ color: "#1a73e8", textDecoration: "none" }}>
                            this page
                          </Link>
                          , but you can only start sharing your location from your mobile device. Location Sharing works
                          across MailG apps and services, including MailG Maps and Family Link.
                        </Typography>
                      </Box>
                    </Box>
                  </Box>
                    ...
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 3 }}>
                        ...
                        <Typography sx={{ color: "text.secondary", maxWidth: 600, mx: "auto", fontSize: "0.875rem" }}>
                          Manage your personal info and control who can see it when you use your main MailG Account
                          profile across MailG services.{" "}
                          <Link href="#" sx={{ color: "#1a73e8", textDecoration: "none" }}>
                            Learn more
                          </Link>
                        </Typography>
                      ...
                      <Card>
                        <Box sx={{ p: 2 }}>
                          ...
                          <Box
                            ...
                            onClick={() => {
                              setEditFormData({
                                ...
                                value: mailGAccountDataPrivacy.profileVisibility.nameVisibility,
                              });
                              setEditDialogOpen("nameVisibility");
                            }}
                          >
                            <Typography
                              sx={{ color: "text.secondary", width: { xs: "40%", md: "25%" }, fontSize: "0.875rem" }}
                            >
                              Name
                            </Typography>
                            <Box
                                ...
                                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, mt: 0.5 }}>
                                  {mailGAccountDataPrivacy.profileVisibility.nameVisibility === "anyone" ? (
                                    <>
                                      ...
                                      <Typography sx={{ fontSize: "0.75rem", color: "#1a73e8" }}>
                                        Visible to anyone
                                      </Typography>
                                    </>
                                  ) : (
                          ...
                          <Box
                            ...
                            onClick={() => {
                              setEditFormData({
                                field: "profilePictureVisibility",
                                value: mailGAccountDataPrivacy.profileVisibility.profilePictureVisibility,
                              });
                          ...
                          <Box
                            ...
                            onClick={() => {
                              setEditFormData({
                                field: "genderVisibility",
                                value: mailGAccountDataPrivacy.profileVisibility.genderVisibility,
                              });
                          ...
                          <Box
                            ...
                            onClick={() => {
                              setEditFormData({
                                ...
                                value: mailGAccountDataPrivacy.profileVisibility.birthdayVisibility,
                              });
                            ...
                            >
                              <Box>
                                <Typography sx={{ fontSize: "0.875rem" }}>
                                  {mailGAccountPersonalInfo.birthday.month.substring(0, 3)}{" "}
                                  {mailGAccountPersonalInfo.birthday.day}, {mailGAccountPersonalInfo.birthday.year}
                                </Typography>
                                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, mt: 0.5 }}>
                        ...
                        <Box sx={{ p: 2 }}>
                          ...
                          <Box
                            ...
                            onClick={() => {
                              setEditFormData({
                                ...
                                value: mailGAccountDataPrivacy.profileVisibility.emailVisibility,
                              });
                          ...
                          >
                            ...
                            >
                              <Box>
                                <Typography sx={{ fontSize: "0.875rem" }}>
                                  {mailGAccountPersonalInfo.emails[0]}
                                </Typography>
                                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, mt: 0.5 }}>
                      ...
                      <Typography sx={{ color: "text.secondary", fontSize: "0.875rem", mt: 2 }}>
                        MailG may use contact info not listed here to reach you. To see more contact info go to the{" "}
                        <Link
                          href="#"
                          onClick={(e) => {
                            e.preventDefault();
                            ...
                            <Box sx={{ mb: 2 }}>
                              ...
                              {mailGAccountPersonalInfo.about.links.map((link, index) => (
                                <Box
                                  ...
                                  onClick={() => {
                                    setEditFormData({
                                      field: "linksVisibility",
                                      value: mailGAccountDataPrivacy.profileVisibility.linksVisibility || "anyone",
                                    });
                                ...
                                >
                                  ...
                                  <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                                    {(mailGAccountDataPrivacy.profileVisibility.linksVisibility || "anyone") ===
                                    "anyone" ? (
                                      <GroupsOutlinedIcon sx={{ fontSize: 14, color: "#1a73e8" }} />
                                    ) : (
                                      <PersonOutlinedIcon sx={{ fontSize: 14, color: "#1a73e8" }} />
                          ...
                          {mailGAccountPersonalInfo.workAndEducation.workHistory.length > 0 && (
                            <Box sx={{ mb: 2 }}>
                              ...
                              <Box
                                ...
                                onClick={() => {
                                  setEditFormData({
                                    field: "workVisibility",
                                    value: mailGAccountDataPrivacy.profileVisibility.workVisibility || "anyone",
                                  });
                              ...
                              >
                                <Box sx={{ flex: 1 }}>
                                  <Typography sx={{ fontSize: "0.875rem" }}>
                                    {mailGAccountPersonalInfo.workAndEducation.workHistory[0]}
                                  </Typography>
                                ...
                                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                                  {(mailGAccountDataPrivacy.profileVisibility.workVisibility || "anyone") ===
                                  "anyone" ? (
                                    <GroupsOutlinedIcon sx={{ fontSize: 14, color: "#1a73e8" }} />
                                  ) : (
                                    <PersonOutlinedIcon sx={{ fontSize: 14, color: "#1a73e8" }} />
                          ...
                          {mailGAccountPersonalInfo.workAndEducation.educationHistory.length > 0 && (
                            <Box sx={{ mb: 2 }}>
                              ...
                              <Box
                                ...
                                onClick={() => {
                                  setEditFormData({
                                    field: "educationVisibility",
                                    value: mailGAccountDataPrivacy.profileVisibility.educationVisibility || "anyone",
                                  });
                              ...
                              >
                                <Box sx={{ flex: 1 }}>
                                  <Typography sx={{ fontSize: "0.875rem" }}>
                                    {mailGAccountPersonalInfo.workAndEducation.educationHistory[0]}
                                  </Typography>
                                </Box>
                                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                                  {(mailGAccountDataPrivacy.profileVisibility.educationVisibility || "anyone") ===
                                  "anyone" ? (
                                    <GroupsOutlinedIcon sx={{ fontSize: 14, color: "#1a73e8" }} />
                                  ) : (
                                    <PersonOutlinedIcon sx={{ fontSize: 14, color: "#1a73e8" }} />
                  ...
                  <CenterColumn>
                    <Box>
                      <Box sx={{ textAlign: "center", mb: 4 }}>
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                          Info about you and your preferences across MailG services
                        </Typography>
                      </Box>
                      ...
                      <Card>
                        <Box sx={{ p: 2 }}>
                          ...
                          <Typography sx={{ color: "text.secondary", fontSize: "0.75rem", mb: 2 }}>
                            Some info may be visible to other people using MailG services.
                          </Typography>
                          ...
                          >
                            ...
                            >
                              <Typography sx={{ fontSize: "0.875rem" }}>
                                {mailGAccountPersonalInfo.nickname || "No nickname"}
                              </Typography>
                              <ChevronRightIcon sx={{ color: "text.disabled" }} />
                            </Box>
                          </Box>
                          ...
                          <Box sx={{ p: 2 }}>
                              ...
                              >
                                <Box sx={{ display: "flex", flexDirection: "column" }}>
                                  {mailGAccountPersonalInfo.emails.map((email, index) => (
                                    <Typography key={index} sx={{ fontSize: "0.875rem" }}>
                                      {email}
                                    </Typography>
                                  ))}
                                </Box>
                            ...
                            >
                              ...
                              >
                                <Box>
                                  <Typography sx={{ fontSize: "0.875rem" }}>
                                    {mailGAccountPersonalInfo.phone.number}
                                  </Typography>
                      ...
                      <Box sx={{ mt: 3 }}>
                        <Card>
                          <Box sx={{ p: 2 }}>
                            ...
                            <Typography sx={{ color: "text.secondary", fontSize: "0.75rem", mb: 2 }}>
                              Manage addresses associated with your MailG Account.{" "}
                              <Link href="#" underline="hover">
                                Learn more about addresses saved to your account
                              </Link>
                            </Typography>
                            <Box
                              sx={{
      ...
      <Dialog open={editDialogOpen === "name"} onClose={handleCancelEdit} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ border: "1px solid #e0e0e0", borderRadius: 2, p: 3, mb: 3 }}>
            ...
            />
            <Typography sx={{ fontSize: "0.75rem", color: "text.secondary", mt: 2 }}>Who can see your name</Typography>
      ...
      <Dialog open={editDialogOpen === "birthday"} onClose={handleCancelEdit} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          ...
          <Typography sx={{ fontSize: "0.875rem", color: "text.secondary", mb: 2 }}>
            If you make your birthday visible, you can also choose to have it highlighted across MailG services (for
            example, by decorating your profile picture)
          </Typography>
      ...
      <Dialog open={editDialogOpen === "updateBirthday"} onClose={handleCancelEdit} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          ...
          <Typography sx={{ fontSize: "0.875rem", color: "text.secondary", mb: 3 }}>
            Your birthday may be used for account security and personalization across MailG services. If this MailG
            Account is for a business or organization, use the birthday of the person who manages the account.
          </Typography>
          ...
          <Box sx={{ border: "1px solid #e0e0e0", borderRadius: 2, p: 3 }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <Button
                ...
                variant="contained"
                disabled={!editFormData.month || !editFormData.day || !editFormData.year}
      ...
      <Dialog open={editDialogOpen === "phone"} onClose={handleCancelEdit} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1, p: 2, bgcolor: "#f5f5f5", borderRadius: 2 }}>
            ...
            <Typography sx={{ fontSize: "0.75rem", color: "text.secondary" }}>
              You may have added phone numbers that aren't listed here. If a number you added to a MailG service isn't
              listed here, go to that service to control how it's used.
            </Typography>
          </Box>
      ...
      <Dialog open={deleteAppDialog !== null} onClose={() => setDeleteAppDialog(null)} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          ...
          <Typography sx={{ color: "text.secondary", mb: 3 }}>
            This will remove {thirdPartyApps.find((app) => app.id === deleteAppDialog)?.name}'s access to your MailG
            Account. You may lose access to the app and its data.
          </Typography>
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 2 }}>
            <Button onClick={() => setDeleteAppDialog(null)} sx={{ textTransform: "none", color: "#1a73e8" }}>
              Cancel
            </Button>
            <Button
              onClick={() => {
      ...
      <Dialog open={editDialogOpen === "addAboutItem"} onClose={handleCancelEdit} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
            <IconButton onClick={handleCancelEdit} sx={{ mr: 2 }}>
              <ChevronLeftIcon />
          ...
          <Box sx={{ border: "1px solid #e0e0e0", borderRadius: 2, p: 3, mb: 3 }}>
            ...
            {editFormData.type === "introduction" ? (
              ...
              <input
                ...
                onChange={(e) => setEditFormData({ ...editFormData, value: e.target.value })}
                placeholder={
                  editFormData.type === "place"
                    ? "e.g., New York, USA"
                    : editFormData.type === "link"
                      ? "e.g., https://example.com"
                      : editFormData.type === "profileLink"
      ...
      <Dialog open={editDialogOpen === "addWorkEducationItem"} onClose={handleCancelEdit} maxWidth="sm" fullWidth>
        <Box sx={{ p: 3 }}>
          <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
            <IconButton onClick={handleCancelEdit} sx={{ mr: 2 }}>
              <ChevronLeftIcon />
          ...
          <Box sx={{ border: "1px solid #e0e0e0", borderRadius: 2, p: 3, mb: 3 }}>
            <Typography sx={{ fontSize: "0.875rem", mb: 2 }}>
              {editFormData.type === "occupation"
                ? "Occupation"
                : editFormData.type === "workHistory"
                  ? "Company/Position"
                  : "School/Degree"}
            </Typography>
      ...
      <Dialog
        open={
          editDialogOpen === "nameVisibility" ||
          editDialogOpen === "genderVisibility" ||
          editDialogOpen === "birthdayVisibility" ||
          editDialogOpen === "emailVisibility" ||
          editDialogOpen === "profilePictureVisibility" ||
          editDialogOpen === "linksVisibility" ||
          editDialogOpen === "workVisibility" ||
          editDialogOpen === "educationVisibility"
        }
