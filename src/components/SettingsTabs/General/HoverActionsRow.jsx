  ...
  return (
    <SettingsRow>
      ...
      <SettingsCell side="right">
        <div>
          <label>
            <SettingsRadio type="radio" name="hoverActions" value="enable" defaultChecked />{" "}
            <BoldLabel style={{ marginLeft: "6px" }}>Enable hover actions</BoldLabel> – Quickly gain access to archive,
            delete, mark as read and snooze controls on hover.
          </label>
        </div>
