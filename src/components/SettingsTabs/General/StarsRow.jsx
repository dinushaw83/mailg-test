    ...
    return (
        <SettingsRow>
            ...
            <SettingsCell side="right">
                <BoldLabel>Drag the stars between the lists.</BoldLabel> They’ll rotate in the
                order shown when you click. <br />
                {/* Presets (simplified version) */}
                <div style={{ marginTop: "8px" }}>
                    <LearnMoreLink as="span">1 star</LearnMoreLink> |{" "}
                    <LearnMoreLink as="span">4 stars</LearnMoreLink> |{" "}
