...
import { SettingsRow, SettingsCell, BoldLabel, LearnMoreLink, SubNote } from "../styles";
...
export default function SignatureRow({ localSignatures, setLocalSignatures }) {
  ...
  return (
    <SettingsRow>
      ...
      <SettingsCell side="right">
        {signatures?.length === 0 ? (
          <>
            <div style={{ fontWeight: "bold", marginBottom: "8px" }}>No signatures</div>
            <Button
              variant="outlined"
              size="small"
              sx={{
