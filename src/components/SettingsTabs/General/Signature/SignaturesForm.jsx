...
import { Popper, ClickAwayListener, Paper, Stack, Typography, IconButton } from "@mui/material";
      ...
      <div className="Tb">
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              setSignaturesState({ ...signaturesState, insertSignatureBeforeQuotedText: e.target.checked })
            }
          />{" "}
  ...
  const applyLink = () => {
    ...
    if (hasTextSelection) {
      ...
      editor
        .chain()
        .focus()
        .insertContent([{ type: "text", text: linkText, marks: [{ type: "link", attrs: { href: linkHref } }] }])
        .run();
    }
    setLinkHref("");
    setLinkText("");
                  ...
                  >
                    <div className="aZ">
                      ...
                      >
                        ...
                        <ToolbarSeparator />
                        <StyledTooltip title={isMacOS() ? "Bold (⌘ B)" : "Bold (Ctrl+B)"} placement="bottom">
                          <MailGToolbarButton
                            aria-label="Bold (⌘B)"
                            role="button"
                        ...
                        <StyledTooltip title={isMacOS() ? "Italic (⌘ I)" : "Italic (Ctrl+I)"} placement="bottom">
                          <MailGToolbarButton
                            aria-label="Italic (⌘I)"
                            role="button"
                        ...
                        <StyledTooltip title={isMacOS() ? "Underline (⌘ U)" : "Underline (Ctrl+U)"} placement="bottom">
                          <MailGToolbarButton
                        ...
                        <StyledTooltip title={isMacOS() ? "Text color" : "Text color"} placement="bottom">
                          <ToolbarButton
                            role="button"
                        ...
                        <ToolbarSeparator />
                        <StyledTooltip title={isMacOS() ? "Link (⌘ K)" : "Link (Ctrl+K)"} placement="bottom">
                          <ToolbarButton
                            role="button"
                            aria-label="Link (⌘K)"
                            className="J-Z-M-I J-J5-Ji"
                        ...
                        <StyledTooltip title={"Align"} placement="bottom">
                        ...
                        <StyledTooltip title="More formatting options" placement="bottom">
