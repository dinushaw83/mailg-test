  ...
  return (
    <SettingsRow>
      <SettingsCell width="20%" side="left">
        ...
        <br />
        <span style={{ fontSize: "0.75rem" }}>(predictive writing suggestions appear as you compose an email)</span>
      </SettingsCell>
      ...
      <SettingsCell side="right">
        ...
        <div style={{ marginTop: "8px" }}>
          <StyledLink href="#">Feedback on Smart Compose suggestions</StyledLink>
        </div>
      </SettingsCell>
    </SettingsRow>
  );
