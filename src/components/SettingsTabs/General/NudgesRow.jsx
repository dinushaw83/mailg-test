import { SettingsRow, SettingsCell, BoldLabel, StyledLink, SettingsCheckbox } from "./styles";
    ...
    <SettingsRow>
      ...
      <SettingsCell side="right">
        ...
        <div style={{ marginTop: "8px" }}>
          <label>
            <SettingsCheckbox type="checkbox" defaultChecked checked={true} onClick={(e) => e.preventDefault()} />
            <BoldLabel style={{ marginLeft: "6px" }}>Suggest emails to follow up on</BoldLabel> – Sent emails you might
            need to follow up on will appear at the top of your inbox
          </label>
        </div>
      </SettingsCell>
    </SettingsRow>
