                  ...
                  <div className="bGI nH oy8Mbf aE3 S4" style={{ padding: 24 }}>
                    ...
                    <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                      ...
                      <div style={{ color: "#5f6368" }}>
                        From: <strong>{email.from.name}</strong> ({email.from.email})
                      </div>
                      <div style={{ color: "#5f6368" }}>
                        To: <strong>{email.to}</strong>
                      </div>
                      <div style={{ marginLeft: "auto", color: "#5f6368" }}>{formattedDate}</div>
                    </div>
                    ...
                    <div style={{ marginTop: 24 }}>
                      <Link to="/" className="T-I T-I-KE L3" style={{ textDecoration: "none" }}>
                        Back to Inbox
                      </Link>
                    </div>
                  </div>
